...
// MARK: - ViewController
final class SelectSportsViewController: BaseSignupTableViewController {

    private let items: [LeftSFIconCellData] = [
        .init(title: "Golf",          iconName: "figure.golf"),
        .init(title: "Tennis",        iconName: "figure.tennis"),
        .init(title: "Pickleball",    iconName: "figure.pickleball"), // or custom asset
        .init(title: "Weightlifting", iconName: "figure.strengthtraining.traditional"),
        .init(title: "Basketball",    iconName: "figure.basketball"),
        .init(title: "Soccer",        iconName: "figure.indoor.soccer")
    ]
    ...
    override func didTapContinue() {
        ...
        let vc = BetterAthleteViewController()
        navigationController?.pushViewController(vc, animated: true)
    }
}

// MARK: - Data Source & Delegate
extension SelectSportsViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.section == 0 {
            ...
            cell.configure(with: "What sports do you play?", fontSize: 35)
            return cell
        }
